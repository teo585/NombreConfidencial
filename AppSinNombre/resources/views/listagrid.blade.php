        ...
        <div class="container">
            <div class="row">
                <div class="container">
                    ...
                    <table id="tlista" name="tlista" class="display table-bordered" width="100%">
                        <thead>
                        <tr>
                        <div class="pestana">Lista</div>
                        </tr>
                            <tr class="btn-default active">
                                <th style="width:40px;padding: 1px 8px;" data-orderable="false">
                                {!!Html::link('lista/create','',array('class' => 'glyphicon glyphicon-plus'))!!}
...
<script type="text/javascript">
    ...
    $(document).ready( function () {
        ...
        /*$('#tlista').DataTable({
            ...
            "aServerSide": true,
            "stateSave":true,
            "ajax": "{!! URL::to ('/datosLista')!!}",
        });*/
        var lastIdx = null;
        var table = $('#tlista').DataTable( {
            "order": [[ 1, "asc" ]],
            "aProcessing": true,
            "aServerSide": true,
            "stateSave":true,
    ...
    $('#tlista tfoot th').each( function () {
        if($(this).index()>0){
        var title = $('#tlista thead th').eq( $(this).index() ).text();
